    ...
    <div className="flex min-h-screen bg-gray-100">
      ...
      <main className={`flex-1 p-6 ${user ? 'md:ml-64' : ''}`}>
        <div className="bg-white shadow rounded-lg p-6 md:p-8">
          <h1 className="text-3xl font-bold text-blue-700 mb-4">Forum</h1>
          ...
          {user ? (
            ...
            <p className="text-lg text-gray-600">
              Możesz przeglądać forum, ale funkcje dodatkowe są dostępne po zalogowaniu.
            </p>
          )}

          <div className="mt-4">
            <p>Tu będzie zawartość strony Forum.</p>
          </div>
        </div>
      </main>
    </div>
